      ...
      <section ref={heroRef} className="relative pt-44 pb-32 px-6 overflow-hidden bg-gradient-to-br from-white via-slate-50 to-indigo-50/30">
        ...
        >
          ...
          >
            <Link
              to="/signup"
              className="group relative px-8 py-4 bg-slate-900 text-white rounded-2xl font-bold flex items-center justify-center gap-3 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1"
            >
            ...
            <Link
              to="/signup/helper"
              className="group relative px-8 py-4 bg-white text-indigo-600 border-2 border-indigo-100 rounded-2xl font-bold flex items-center justify-center gap-3 overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:border-indigo-200"
            >
              <span className="relative z-10 flex items-center gap-2">
                Sign up as Helper
