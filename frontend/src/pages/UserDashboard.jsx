  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex pt-16">
        ...
        <motion.div
          className="flex-1"
          animate={{ marginLeft: '240px' }}  // Adjusts when sidebar is open (240px) or collapsed (80px) — controlled by SideBar state
          ...
          <div className="bg-white rounded-xl w-full max-w-md p-6 relative">
            ...
            <form onSubmit={handleCreateRequest} className="space-y-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setNewRequest({ ...newRequest, pickup_address: e.target.value })
                }
                required
              />
              ...
              <input
                ...
                onChange={(e) =>
                  setNewRequest({ ...newRequest, destination_address: e.target.value })
                }
                required
              />
              ...
              <div className="grid grid-cols-2 gap-4">
                <input
                  ...
                  onChange={(e) =>
                    setNewRequest({ ...newRequest, needed_date: e.target.value })
                  }
                  required
                />
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewRequest({ ...newRequest, needed_time: e.target.value })
                  }
                  required
                />
              </div>
